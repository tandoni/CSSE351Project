...
public:
	Program4()
	{
		...
		char const * path = "billy";

		state.init("resources/terrain.obj", "resources/reflectance.vert", "resources/reflectance.frag");

		//Add models
		/*Model m = Model();
		m.init("resources/finalCannon.obj", "resources/reflectance.vert", "resources/reflectance.frag");
